...
def sigmoid_projection(daily_total_infections):
...
def plot_provincial_data(province_id):
    ...
    day_list, y_pred, y_pred_min, y_pred_max = sigmoid_projection(daily_total_infections)
...
cumulative_projected_total_max = plot_provincial_data(35)
...
for province_id in range(36, 46):
    ...
    all_province_projection_data_max[str(province_id)] = plot_provincial_data(province_id)
